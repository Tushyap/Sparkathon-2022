...
class CreateEmployeeComponent extends Component {
    ...
    getTitle(){
        if(this.state.id === '_add'){
            return <h3 className="text-center" style={{fontWeight:
            "bold", color:"#4E4C97"}}>Add Employee</h3>
        }else{
            return <h3 className="text-center" style={{fontWeight:
            "bold", color:"#4E4C97" }}>Update Employee</h3>
        }
    }
    render() {
        return (
            <div>
                <br></br>
                   <div className = "container">
                        <div className = "row">
                            <div className = "col-md-6 offset-md-3 offset-md-2" >
                                {
                                    this.getTitle()
                                }
                                ...
                                <div className = "card-body">
                                    <form className='form-horizontal'>
                                        ...
                                        <button className="btn save" onClick={this.saveOrUpdateEmployee}>Save</button>
